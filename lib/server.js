 ...
 * @param {string} opts.coin[='HUSH'] - The coin for this wallet (HUSH).
 * @param {string} opts.network[='livenet'] - The Hush network for this wallet.
 ...
 * @param {string} opts.coin[='HUSH'] - The expected coin for this wallet (HUSH).
 ...
 * @param {string} opts.unit - Hush unit used to format amounts in notifications.
 */
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['HUSH', 'bit'], value.toLowerCase()); //TODOWHAT is BIT???? is it BCH?
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='HUSH'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'HUSH'] - The coin to estimate fee levels from.
 * @param {string} [opts.network = 'livenet'] - The Hush network to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'HUSH'] - The coin for this transaction.
 * @param {string} [opts.network = 'livenet'] - The Hush network for this transaction.
